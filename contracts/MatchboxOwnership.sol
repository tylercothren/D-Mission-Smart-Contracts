...
/// @title The facet of the D-Mission! core contract that manages ownership, ERC-721 (draft) compliant.
...
contract MatchboxOwnership is MatchboxBase, ERC721 {
    ...
    ///  _approve() and transferFrom() are used together for putting Matchbox on auction, and
